...
DESCRIPTION="Windows and Linux driver for Saitek Radio Panel"
HOMEPAGE="https://github.com/daibach142/SaitekRadio"

SRC_URI="https://github.com/daibach142/SaitekRadio/archive/v${PV}.tar.gz -> ${P}.tar.gz
	$(cargo_crate_uris)"
...
QA_FLAGS_IGNORED="usr/bin/saitekradio"  # FIXME: Is this needed?

LICENSE="GPL-3"
SLOT="0"
KEYWORDS="~amd64"

RUST_SRC_DIR=code/saitekradio/
# NOTE: "S"
...
src_install() {
	...
	doins ../../saitekradio.nas

	insinto /usr/share/flightgear/Protocol/
	doins ../../saitekradio.xml

	insinto /usr/share/X11/xorg.conf.d/
	newins ../../55-saitekpanels.conf 55-saitek-radio-panel.conf

	udev_newrules ../../55-saitek.rules 55-saitek-radio-panel.rules
	udev_reload
}
